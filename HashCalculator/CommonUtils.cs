...
{
    public static readonly object AlgoSelectionLock = new();
}
...
{
    private readonly Dictionary<string, List<string>> nameHashs = new();
    ...
    public CmpRes Verify(string name, string hash)
    {
        ...
        if (this.nameHashs.Keys.Count == 1
            && this.nameHashs.ContainsKey(string.Empty))
...
internal class ModelStarter
{
    ...
    private readonly BlockingCollection<HashViewModel> queue = new();
